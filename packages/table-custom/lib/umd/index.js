(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('antd'), require('@ant-design/icons'), require('use-local-storage-state'), require('react-dom')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'antd', '@ant-design/icons', 'use-local-storage-state', 'react-dom'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.TableCustom = {}, global.React, global.antd, global.icons, global.useLocalStorageState, global.reactDom));
})(this, (function (exports, React, antd, icons, useLocalStorageState, reactDom) { 'use strict';
