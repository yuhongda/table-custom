import o, { useRef, useDebugValue, createElement, useContext, useState, useEffect } from 'react';
import { Table, Modal, Checkbox, Divider, Row, Col } from 'antd';
...
const TableCustom = (_a) => {
  ...
  const [columsLocalStorage, setColumsLocalStorage, { removeItem }] = useLocalStorageState(
  ...
  return /* @__PURE__ */ o.createElement(Container, null, /* @__PURE__ */ o.createElement(Toolbar, null, /* @__PURE__ */ o.createElement(SettingOutlined, {
    onClick: () => setVisible(true)
  })), /* @__PURE__ */ o.createElement(Table, __spreadValues({
    columns: tableColumns
  }, rest)), /* @__PURE__ */ o.createElement(Modal, {
    title: "\u6307\u6807\u8BBE\u7F6E",
    width: 800,
    open: visible,
    visible,
    ...
    footer: null
  }, /* @__PURE__ */ o.createElement(Checkbox.Group, {
    value: checkedList,
  ...
  }, options == null ? void 0 : options.map((o$1) => {
    var _a3, _b2;
    const checkedChildren = (_a3 = o$1.children) == null ? void 0 : _a3.filter((c) => checkedList.includes(c.value));
    const indeterminate = (checkedChildren == null ? void 0 : checkedChildren.length) > 0 && (checkedChildren == null ? void 0 : checkedChildren.length) < ((_b2 = o$1.children) == null ? void 0 : _b2.length);
    return /* @__PURE__ */ o.createElement("div", {
      key: o$1.value,
      style: { width: "100%" }
    }, /* @__PURE__ */ o.createElement(Divider, {
      orientation: "left",
      orientationMargin: "0",
      style: { margin: "24px 0 8px 0" }
    }, /* @__PURE__ */ o.createElement(Checkbox, {
      value: o$1.value,
      disabled: o$1.disableCustom,
      indeterminate
    }, /* @__PURE__ */ o.createElement("span", {
      style: { fontSize: 16 }
    }, o$1.label))), o$1.children && o$1.children.length > 0 && /* @__PURE__ */ o.createElement(Row, {
      style: { width: "100%" }
    }, o$1.children.map((c) => /* @__PURE__ */ o.createElement(Col, {
      span: 6
    }, /* @__PURE__ */ o.createElement(Checkbox, {
      value: c.value,
...
export { TableCustom, index as default };
