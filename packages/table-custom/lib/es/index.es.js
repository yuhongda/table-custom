import React, { useRef, useDebugValue, createElement, useContext, useMemo, useLayoutEffect, useEffect, useCallback, useState, createContext, memo, useReducer } from 'react';
import { Table, Modal, Checkbox, Row, Col, Divider } from 'antd';
...
const TableCustom = (_a) => {
  ...
  return /* @__PURE__ */ React.createElement(Container, null, openCustomModal === void 0 ? /* @__PURE__ */ React.createElement(Toolbar, null, /* @__PURE__ */ React.createElement(SettingOutlined, {
    onClick: () => setVisible(true)
  })) : null, /* @__PURE__ */ React.createElement(Table, __spreadValues({
    ...
    return isNoChildrenOptions ? /* @__PURE__ */ React.createElement(CheckboxItem, __spreadProps(__spreadValues({
      key: o.value,
      id: o.value
    }, o), {
      sortable,
      sortHandler
    })) : /* @__PURE__ */ React.createElement(CheckboxGroupItem, __spreadProps(__spreadValues({
      key: o.value,
      id: o.value
    }, o), {
      indeterminate,
      sortable,
      sortHandler
    }), o.children && o.children.length > 0 && /* @__PURE__ */ React.createElement(DndContext, {
      sensors,
      collisionDetection: closestCenter,
      ...
      strategy: rectSortingStrategy
    }, o.children.map((c, i) => /* @__PURE__ */ React.createElement(CheckboxItem, __spreadProps(__spreadValues({
      key: c.value,
      id: c.value
    }, c), {
      sortable,
...
const CheckboxItem = (props) => {
  ...
  return /* @__PURE__ */ React.createElement(Col, __spreadValues({
    span: 6,
    ref: setNodeRef,
    style
    ...
    value: props.value,
    disabled: props.disableCustom
  }, props.label), props.sortable ? /* @__PURE__ */ React.createElement(Handler, __spreadValues({
...
const CheckboxGroupItem = (props) => {
  ...
  return /* @__PURE__ */ React.createElement("div", __spreadValues({
    ...
    ref: setNodeRef,
    style
  }, attributes), /* @__PURE__ */ React.createElement(Divider, {
    orientation: "left",
    orientationMargin: "0",
